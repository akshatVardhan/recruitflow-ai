# RecruitFlow AI - Archived Agent Run Log

# Older session entries relocated from .agents/agent-run-log.md.
# The live file keeps the 5 most recent sessions plus the TEMPLATE.
